...
CONFIG = ROOT / "configs" / "r077_confidence_owned_length_0_3k_gate.env"
R076_CONFIG = ROOT / "configs" / "r076_early_guide_length_0_3k_gate.env"
LAUNCHER = (
    ROOT
    / "scripts"
    / "server"
    / "run_panda_r077_confidence_owned_length.sh"
)
DOC = ROOT / "docs" / "r077_confidence_owned_length.md"
R076_SOURCE = 'source "${CONFIG_DIR}/r076_early_guide_length_0_3k_gate.env"'
...
def test_r077_sources_r076_and_changes_exactly_two_assignments() -> None:
    source = CONFIG.read_text(encoding="utf-8")

    assert source.count(R076_SOURCE) == 1
    after_source = source.split(R076_SOURCE, 1)[1]
    assignments = [
        line.strip()
...
def test_r077_launcher_enforces_strict_from_zero_h100_3k_gate() -> None:
    source = LAUNCHER.read_text(encoding="utf-8")

    required_inputs = (
        ': "${PROJECT_ROOT:?Set PROJECT_ROOT to the reviewed source checkout}"',
        ': "${EXPECTED_SOURCE_COMMIT:?Set EXPECTED_SOURCE_COMMIT}"',
        ': "${RUNTIME_ROOT:?Set RUNTIME_ROOT to a new R077 runtime directory}"',
    ...
    required_fragments = (
        'CONFIG_PATH="$PROJECT_ROOT/configs/r077_confidence_owned_length_0_3k_gate.env"',
        ...
        'OUTPUT_DIR="$RUNTIME_ROOT/outputs/panda_r077_confidence_owned_length_0_3k_h100_20260831"',
        ...
        'RUN_ID=panda_r077_confidence_owned_length_fullres_preflight_20260831',
        'RUN_ID=panda_r077_confidence_owned_length_0_3k_h100_20260831',
        'RUN_PREFLIGHT=1 \\',
